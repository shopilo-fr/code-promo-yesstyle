...
Sursa: https://shopilo.fr/reductions/yesstyle.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/yesstyle.com"
STORE_NAME = "YesStyle"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour YesStyle depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-yesstyle)"
    }
    try:
